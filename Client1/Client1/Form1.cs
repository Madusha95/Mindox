...
namespace Client1
{
    public partial class Form1 : Form
    {
                ...
                if (message.Trim() == "ALL")
                {
                    ...
                    lock (lockObject)
                    {
                        ...
                        if (isBusy)
                        {
                            ...
                            byte[] busyMessage = Encoding.ASCII.GetBytes("CLIENT1BUSY");
                    ...
                    if (shouldProcess)
                    {
                        try
                        {
                            ...
                            byte[] ackMessage = Encoding.ASCII.GetBytes("CLIENT1ACK");
                            lock (streamLock) // Use dedicated stream lock
                            {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            button1.Text = isOn1 ? "ON" : "OFF"; // Update the button text to display the current state: "ON" or "OFF"
